        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 mb-4 mb-lg-0">
                    <img src="{{ asset('assets/images/avatar.avif')}}" alt="About Me" class="img-fluid rounded-circle">
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <ul class="list-unstyled">
                                <li class="mb-2"><strong>Name:</strong> MD Mainuddin Khan</li>
                                <li class="mb-2"><strong>Email:</strong> softmainu@gmail.com</li>
                                <li class="mb-2"><strong>Phone:</strong> 01771211148</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <ul class="list-unstyled">
