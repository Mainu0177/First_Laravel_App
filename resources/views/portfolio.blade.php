        ...
        <div class="container">
            ...
            <div class="row g-4 portfolio-grid">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="web">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="{{ asset('assets/images/ecommerce.jpg')}}" class="card-img-top" alt="E-commerce Website">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="app">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="{{ asset('assets/images/gym.jpg')}}" class="card-img-top" alt="Fitness App">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="web">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="{{ asset('assets/images/corporate.jpg')}}" class="card-img-top" alt="Corporate Website">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="graphic">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="{{ asset('assets/images/brand.jpg')}}" class="card-img-top" alt="Brand Identity">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="app">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="{{ asset('assets/images/travel.jpg')}}" class="card-img-top" alt="Travel App">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="web">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="{{ asset('assets/images/restaurant.jpg')}}" class="card-img-top" alt="Restaurant Website">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/ecommerce.jpg')}}" class="img-fluid mb-4" alt="E-commerce Website">
    ...
    <div class="modal fade" id="project2Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/gym.jpg')}}" class="img-fluid mb-4" alt="Fitness App">
    ...
    <div class="modal fade" id="project3Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/corporate.jpg')}}" class="img-fluid mb-4" alt="Corporate Website">
    ...
    <div class="modal fade" id="project4Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/brand.jpg')}}" class="img-fluid mb-4" alt="Brand Identity">
    ...
    <div class="modal fade" id="project5Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/travel.jpg')}}" class="img-fluid mb-4" alt="Travel App">
    ...
    <div class="modal fade" id="project6Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/restaurant.jpg')}}" class="img-fluid mb-4" alt="Restaurant Website">
